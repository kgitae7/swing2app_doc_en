...
**We will introduce you to the basic pages required to create a shopping mall app and how to apply the app.**

Since the Swing-to-App can build a shopping mall app, many people have applied for and used the 'Swing Shop', a shopping mall feature provided by the Swing-to-App app.

In addition to product registration, the basic pages required for the shopping mall app are provided by the app creation.

We provide all the shopping mall pages such as shopping mall main screen, shopping cart, my page, check my purchase history, search for products, etc.
...
→ the STEP3 page → the app creation, select \[Store Function] in the page design → select \[Page]\*\* to see the pages related to the swing shop (the page required to operate the mall).

![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EC%87%BC%ED%95%91%EB%AA%B02.png)

**\[Swing Shop Ji-an Lee Provided]**

**- Customer (for users) page: Cart, My Page**
...
So if you use the swing shop, you can select **Page Design – Shopping Mall Function – Page in App Creation** to see all the menus related to the swing shop.

You can apply the required pages of these pages to the app and use them.
...
### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **1.** Shopping Mall Main Page

![](https://wp.swing2app.co.kr/wp-content/uploads/2020/07/%EC%87%BC%ED%95%91%EB%AA%B0%EB%A9%94%EC%9D%B8.png)

The shopping mall main page is the main home screen page suitable for application to the home screen.
...
You don't have to apply the page as a home screen, so you can customize it to suit your app's style ^^
...
You can apply it to your home screen, or you can add it to a menu.
...
6\) Find the 'Shopping Mall Main' page and select the \[Apply] button. (Hover the mouse cursor over the page and the Apply button opens)

7\) Press the \[Save] button at the top of the screen to apply it to the app.

![](https://wp.swing2app.co.kr/wp-content/uploads/2020/07/%EC%BA%A1%EC%B2%98.png)

### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **2.** Cart
...
You can check the items you put in your shopping cart to make a purchase.다.
...
### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **4.** Digital Product Purchase Complete Page

![](https://wp.swing2app.co.kr/wp-content/uploads/2020/07/%EB%94%94%EC%A7%80%ED%84%B8%EA%B5%AC%EB%A7%A4%EC%83%81%ED%92%88.png)

This page is only available if you have registered a digital product\_Page dedicated to digital products
...
### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **6.** Shopping Mall Information
...
### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **7.**Product Search
...
### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **8.** Schedule (Date) Booking Products

![](https://wp.swing2app.co.kr/wp-content/uploads/2020/07/%EB%82%A0%EC%A7%9C%EC%98%88%EC%95%BD%EC%83%81%ED%92%88.png)

This page is only available if you have registered the reservation system\_page dedicated to the reservation system
...
As you can see in the image above, the Calendar window shows Check-in, Check-out.

When the date lookup is complete, the products available for that date will be viewed..

![](https://wp.swing2app.co.kr/wp-content/uploads/2020/07/%EC%BA%A1%EC%B2%98.png)

### ![](https://wp.swing2app.co.kr/wp-content/uploads/2022/07/%EB%8B%A8%EB%9D%BD1-1.png) **9.** Book a Time + Date Reservation

![](https://wp.swing2app.co.kr/wp-content/uploads/2020/07/%EC%8B%9C%EA%B0%84%EC%98%88%EC%95%BD%EC%83%81%ED%92%88.png)

This page is only available if you have registered the reservation system\_page dedicated to the reservation system

The second is the **\[Book Time + Date Reservations] page.**
...
Therefore, if you have registered for a date and time reservation, you can apply the second page\*\*.\*\*

{% hint style="warning" %}
**Swing Shop (Shopping Mall) Basic Ji-an Lee**
...
Or, in addition to modifying the pages provided by the Swing-to-App app, adding new pages also needs to be customized.
...
Depending on what kind of product you are selling, there are some pages you need, so please check and operate it.
