...
![](https://support.swing2app.com/wp-content/uploads/2018/10/app\_upload.png)
...
![](https://wp.swing2app.co.kr/wp-content/uploads/2018/10/%EC%8A%A4%EC%9C%99-%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EC%9D%B8-%EC%A0%9C%EB%AA%A9%EC%84%AC%EB%84%A4%EC%9D%BC.png)

**The guidelines will explain how to fill out an upload application.**

![](https://support.swing2app.com/wp-content/uploads/2018/10/h10.png)
...
5\) Update Changes: **If you update from the existing app to the new version, you can write the changed contents.**
...
**6) Support URL: If there is an active homepage, enter the URL**.
...
![](https://support.swing2app.com/wp-content/uploads/2018/10/h11.png)

**7) Privacy Policy: Enter the privacy policy URL (link).**
...
**8) Screenshot Image – iPhone 8 Plus (1242X2208 Pixel Size)**

**9) Screenshot Image – iPhone X (1242X2688 Pixel Size)**
...
**10) Category**: Determines the category items classified in the App Store. Please select the category that suits your personality.

**11) Please select an App Store upload account.**
...
You do not need to create an Apple Developer account, <mark style="color:blue;">**and your app will be registered with our developer account, HYUSTAY.CO.**</mark>
...
![](https://support.swing2app.com/wp-content/uploads/2018/10/h13.png)
...
– After creating an account at [http://developer.apple.com/](http://developer.apple.com/) Apple Developer Registration site, you should pay the fee of $129 per year.

(Apple Developer account must be registered on the above site. This is not a personal account)

\-Register your account and enter your IOS ID and password on the application form.



**12) App store app registration usage policy agreement**

![](https://support.swing2app.com/wp-content/uploads/2018/10/h12.png)

Please be sure to read the App Store Terms of Use by clicking the appropriate button and check **‘I agree’**.

​

13\) Click the <mark style="color:blue;">**\[Apply]**</mark>  button to complete the app store upload request.
...
App Store review takes about 1 week to 2 weeks. Please note that the review period is long.
...
2. App store review takes about 1 week to 2 weeks. Please note that the review period is long.\
